...
#     """
#     ## Print passwords from multiple projects.
#
#     The body parameters are:
#         - format: pdf or csv (default pdf),
...
#
      ...
      ## TODO: if an admin is member of a group, the teacher may see his PW,
      ## SO IT'S NECESSARY to filter the user's list first.
